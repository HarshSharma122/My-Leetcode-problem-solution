public class Difference_between_element_sum_and_digit_sum_of_an_array {
    public static int differenceOfSum(int[] nums) {
        int elementSum = 0;
        int digitSum = 0;
        int n = 0;// this is Global Variable
        //Element sum is always greater than digitSum
        //This funda is always clear that when you subtract (ElementSum - DigitSum)
